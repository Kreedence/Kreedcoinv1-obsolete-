...
const QString BITCOIN_IPC_PREFIX("kreedcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/kreedcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/kreedcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/kreedcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click kreedcoin: links
...
//
// OSX-specific way of handling kreedcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in kreedcoin: URIs
