...
#if defined(NDEBUG)
# error "Kreedcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Kreedcoin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Kreedcoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Kreedcoin also requires low S in sigs
