...
BOOST_AUTO_TEST_CASE(test_addresses)
{
    ...
    std::vector<std::string> pubkey = {"kreedcoin:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "kreedcoin:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "kreedcoin:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {"kreedcoin:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "kreedcoin:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "kreedcoin:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
