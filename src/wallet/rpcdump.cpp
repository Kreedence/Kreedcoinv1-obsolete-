...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"kreedcoinaddress\"\n"
            "\nReveals the private key corresponding to 'kreedcoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"kreedcoinaddress\"   (string, required) The kreedcoin address for the private key\n"
            "\nResult:\n"
