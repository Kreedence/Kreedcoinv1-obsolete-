...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Kreedence/Kreedcoin>";
    const std::string URL_WEBSITE = "<https://kreedcoin.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Kreedcoin Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Kreedcoin useful. "
